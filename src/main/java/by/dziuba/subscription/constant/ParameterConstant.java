package by.dziuba.subscription.constant;
...
public final class ParameterConstant {
    ...
    public static final String BOOKS_AMOUNT = "books";
    ...
    public static final String PERIODICAL_TYPES = "periodicalTypes";
    public static final String PERIODICAL_TYPE = "periodicalType";
    public static final String PERIODICAL_GENRES = "periodicalGenres";
